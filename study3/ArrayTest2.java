...
public class ArrayTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println( jumsu[0][2]  ); // 80
		
		System.out.println( jumsu[1][0]  ); // 50
		System.out.println( jumsu[1][1]  ); // 60
		System.out.println( jumsu[1][2]  ); // 100
		
		System.out.println( jumsu[2][0]  ); // 90
		System.out.println( jumsu[2][1]  ); // 70
		System.out.println( jumsu[2][2]  ); // 78
