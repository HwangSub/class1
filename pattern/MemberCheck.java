...
public class MemberCheck {
	...
	public static void main(String[] args) {
		...
		System.out.println( "전번:"+phone.matches(ptn6) );
		
		// 이메일 aa@naver.com
		// 아이디@도메인명.(com)(co.kr)(net)
		String email = "test12@naver.com";
		String ptn7 = 
	 "[a-zA-Z]{1}[0-9a-zA-Z]{5,11}@[a-zA-Z0-9]+\\.[a-zA-Z0-9]+";
