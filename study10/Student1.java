...
public class Student1 {
   ...
   //   참조클래스   참조변수 = 객체처리
	...
	//	System.out.println("수학 : " + math);
		...
		int hong_sum = info1.eng + info1.kor + math;
		int kim_sum  = info2.eng + info2.kor + math;
		
		System.out.println("홍길동 총점 : " + info1.hap());
		System.out.println("김철수 총점 : " + info2.hap());
		
		System.out.println("홍길동 평균 : " + info1.avg());
		System.out.println("김철수 평균 : " + info2.avg());
